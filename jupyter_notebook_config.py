...
_org = os.getenv('FIDDLER_ORG', 'onebox')
_org_root = os.getenv('FIDDLER_ORG_ROOT', '/app/fiddler_samples')
...
# c.NotebookApp.base_url = f'/fidlbook/{_org}'
...
c.NotebookApp.notebook_dir = _org_root
...
##
c.ContentsManager.root_dir = _org_root
...
##
c.FileContentsManager.root_dir = _org_root
